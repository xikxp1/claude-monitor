...
Codex Monitor is a Tauri 2 desktop application that monitors Codex API usage. It runs in the system tray and displays usage statistics in a dashboard window.
